...
<div class="profile-container">
    ...
    <div class="profile-card">
        ...
        <form action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data" id="photoForm" style="display: none;">
            @csrf
            @method('PUT')
            <input type="file" name="profile_photo" id="photoUpload" accept="image/*" onchange="document.getElementById('photoForm').submit()">
        </form>
